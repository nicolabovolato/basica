...
Let's start by bringing AppBuilder into scope and registering our dependencies through `registerDependencies`. Basica provides a default logger automatically, so we only need to register our service.

We then register sample, our service, as an entrypoint.
...
```js
{...,"name":"@basica:app:lifecycle","msg":"Lifecycle: 1 entrypoint(s) (1 startable, 1 stoppable)"}
{...,"name":"@basica:app:lifecycle","msg":"Starting 1 entrypoint(s)"}
...
{...,"name":"@basica:app:lifecycle","msg":"Stopping 1 entrypoint(s)"}
{...,"name":"test","msg":"Goodbye!"}
{...,"name":"@basica:app:lifecycle","msg":"Stopped 1/1 entrypoint(s)"}
```
...
{...,"name":"@basica:app","msg":"Received manual shutdown, shutting down..."}
{...,"name":"@basica:app:lifecycle","msg":"Stopping 1 entrypoint(s)"}
{...,"name":"@basica:app:lifecycle","msg":"Stopped 0/1 entrypoint(s)"}
